...
const Rating = (props) => {
    ...
    return (
        <div style={{ width: "50%" }}>
            <h1 style={{ fontSize: "2vw", fontFamily: "'Ubuntu', sans-serif", color: "#FF6037", borderBottom: "2px solid #FF6037", display: "inline-block" }}>On the basis of problem rating :</h1>
            <div>
                {ChartData && type ?
                    <Bar
                        data={{
            ...
            <span style={{ marginLeft: "50%" }}>
                ...
                <h1 style={{ fontSize: "1vw", fontFamily: "'Ubuntu', sans-serif", color: "#FF6037", display: "inline" }}>Pie Chart</h1>
            </span>
        </div>
    )
}
